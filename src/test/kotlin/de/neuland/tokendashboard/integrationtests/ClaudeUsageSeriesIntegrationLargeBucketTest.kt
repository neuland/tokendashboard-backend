...
class ClaudeUsageSeriesIntegrationLargeBucketTest :
    FunSpec({
        val db = TestDatabase()
        beforeSpec {
            db.start()
        ...
        test("GET /api/usage/claude/series/v1 sums fake usage data into per-week buckets across a 4-week range") {
            ...
            val sql =
                object {}
                    .javaClass
                    .getResourceAsStream("/fill_usage_rows_claude.sql")!!
                    .bufferedReader()
                    .use { it.readText() }
            ...
            testApplication {
                ...
                val response =
                    jsonClient
                        .get("/api/usage/claude/series/v1?from=2026-06-02&to=2026-06-29&granularity=week")
